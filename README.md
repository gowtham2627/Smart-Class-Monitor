...
- 📄 dlib-19.22.99-cp310-cp310-win_amd64.whl → Prebuilt dlib file  
...
⚠️ dlib is required for face recognition. It might fail if build tools are missing.
...
pip install cmake
pip install dlib
If still not working, use the prebuilt .whl file:
...
📸 Adding Users
Just add images to the known_faces/ folder:

known_faces/
├── USER6.jpg
├── USER7.jpg
➡️ User names are extracted from the image file names.
...
🧪 Sample Testing
Run individual modules like this:
